...
object SourceType {
    ...
    /** Checks whether a content URI belongs to a cloud/JS-engine song that needs dynamic URL resolution. */
    fun isCloudLxUri(uri: String): Boolean = uri.startsWith("cloud://lx/")
}
