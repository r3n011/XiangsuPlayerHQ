...
interface MusicRepository {
    ...
    /**
     * Saves or updates a cloud/JS-engine song to the database so it can be favorited and played from the library.
     * @return The generated Long ID for the saved song.
     */
    suspend fun saveCloudSong(songInfo: com.theveloper.pixelplay.data.lx.LxSongInfo): Long

    /**
     * Checks whether a cloud song exists in the database.
     */
    suspend fun isCloudSongSaved(songInfo: com.theveloper.pixelplay.data.lx.LxSongInfo): Boolean
     ...
     * @return the song ID string, or null if no match found.
     */
    suspend fun getCloudSongIdByTitleArtist(title: String, artist: String): String?
